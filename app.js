...
// Función para guardar TODOS los pronósticos modificados (igual que antes)
async function saveAllPredictions() {
  ...
  if (!confirm(`¿Guardar ${modifiedMatches.length} pronóstico${modifiedMatches.length > 1 ? 's' : ''}?`)) return;
